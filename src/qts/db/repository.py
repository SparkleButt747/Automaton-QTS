...
class SignalRepository:
    ...
    async def insert_snapshot(self, snapshot: SignalSnapshot) -> SignalSnapshotRow:
        ...
        row = SignalSnapshotRow(
            ...
            vol_regime=snapshot.vol_level.value,
            vol_regime_confidence=snapshot.vol_level_confidence,
    ...
    async def insert_snapshots(self, snapshots: list[SignalSnapshot]) -> list[SignalSnapshotRow]:
        ...
        rows = [
            SignalSnapshotRow(
                ...
                vol_regime=s.vol_level.value,
                vol_regime_confidence=s.vol_level_confidence,
    ...
    async def get_snapshots(
        ...
        return [
            SignalSnapshot(
                ...
                vol_level=VolLevel(r.vol_regime),
                vol_level_confidence=r.vol_regime_confidence,
    ...
    async def get_latest_snapshot(self, symbol: str) -> SignalSnapshot | None:
        ...
        return SignalSnapshot(
            ...
            vol_level=VolLevel(row.vol_regime),
            vol_level_confidence=row.vol_regime_confidence,
...
class TradeRepository:
    ...
    async def insert_trade(self, trade: TradeRecord) -> TradeRecordRow:
        ...
        row = TradeRecordRow(
            ...
            vol_regime_at_entry=trade.vol_level_at_entry.value,
    ...
    async def insert_trades(self, trades: list[TradeRecord]) -> list[TradeRecordRow]:
        ...
        rows = [
            TradeRecordRow(
                ...
                vol_regime_at_entry=t.vol_level_at_entry.value,
    ...
    def _row_to_domain(row: TradeRecordRow) -> TradeRecord:
        ...
        return TradeRecord(
            ...
            vol_level_at_entry=VolLevel(row.vol_regime_at_entry),
